...
from testimf import myImageResize
from testimf import myImageResize2
...
downsampled_im_bilinear_pixels2 = myImageResize2(orig_im_pixels, 100, 175, 'bilinear')
...
downsampled_im_bilinear2 = Image.fromarray(np.uint8(downsampled_im_bilinear_pixels2.round()))

# Show the image.
downsampled_im_bilinear.show()
downsampled_im_bilinear2.show()
